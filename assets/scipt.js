...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=a1a361d8757d77f77eb0a30c35c4ca26";
    $.ajax({
        url: queryURL,
        method: "GET"
...
function showPrevious() {
    //show the previously searched for locations
    if (savedLocations) {
        $("#prevSearches").empty();
...
function getCurrent(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=a1a361d8757d77f77eb0a30c35c4ca26";
    $.ajax({
        url: queryURL,
        method: "GET",
        error: function (){
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=a1a361d8757d77f77eb0a30c35c4ca26" + response.coord.lat + "&lon=" + response.coord.lat;
        $.ajax({
            url: uvURL,
            method: "GET"
...
function getForecast(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&APPID=a1a361d8757d77f77eb0a30c35c4ca26";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
